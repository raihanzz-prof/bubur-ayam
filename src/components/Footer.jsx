...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      icon: MessageCircle,
      href: "https://wa.me/628777998511?text=Halo%20Mas%20Yanto,%20saya%20ingin%20bertanya%20tentang%20menu%20bubur%20ayam.",
      label: "WhatsApp",
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-14 h-14 rounded-2xl overflow-hidden shadow-xl shadow-orange-500/30">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Legenda sarapan pagi sejak 2013. Selalu hangat, selalu nikmat,
              selalu bikin kangen.
            </p>
              ...
              <li className="group flex items-start gap-3 text-gray-400">
                ...
                <div className="flex-1">
                  <p className="text-sm leading-relaxed">
                    Jl. Letjen M.T. Haryono, RT.4/RW.1, Cawang,
                    <br />
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              Kunjungi warung kami untuk pengalaman sarapan terbaik
            </p>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-orange-500/20">
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3966.1506536435245!2d106.86599199999999!3d-6.243868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNsKwMTQnMzcuOSJTIDEwNsKwNTEnNTcuNiJF!5e0!3m2!1sid!2sid!4v1769753525900!5m2!1sid!2sid"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen=""
              ...
              title="Lokasi Bubur Ayam Mas Yanto"
            ></iframe>
          </div>
        </div>
